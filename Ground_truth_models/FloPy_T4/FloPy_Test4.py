...
# wel_rec1 = [(Nlay - 1, int(N / 4), int(N / 4), q)]
# wel_rec2 = [(Nlay - 1, int(N / 4), int(N * 3 / 4), q)]
# wel_rec = {0: wel_rec1, 1: wel_rec2}
...
# create monitoring wells - change to an option below to create different monitoring well configurations
...
# np.savetxt('FloPy_Test3_monitoring_wells.csv',m_well2,delimiter=',')     
...
plt.title("Pumping = 1000, Recharge = 0", size=16)
plt.axis('equal')
ax.set_aspect('auto')
ax.set_xbound(0,400)
